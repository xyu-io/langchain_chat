...
import (
	...
	"langchain_chat/third/langchaingo/llms/googleai"
	"langchain_chat/third/langchaingo/llms/googleai/vertex"
)
...
func testMultiContentImageLink(t *testing.T, llm llms.Model) {
	...
	parts := []llms.ContentPart{
		llms.ImageURLPart(
			"https://langchain_go/third/langchaingo/blob/main/docs/static/img/parrot-icon.png?raw=true",
		),
